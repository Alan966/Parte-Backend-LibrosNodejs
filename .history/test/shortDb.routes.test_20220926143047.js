...
describe('POST /shortDb/create', () => {
    ...
    describe('given a valid reques', () => {
        const data = {
            "_id":"5523416119",
            "listing_url":"https://cdn-images.farfetch-contents.com/16/82/01/85/16820185_33351106_1000.jpg",
            "name":"noseQue",
            "summary":"Nuevo temperamento mis brows",
            "space":"este es un space ",
            "description":"Ya no se que poner we ya me aburri ",
            "neighborhood_overview":"tenis si the first or the second",
            "notes":"meteleduro",
            "transit":"mete duro metele duro",
            "access":"you don't need don't need there , there is debit card bro",
            "interaction":"Nostros with necesitamos nada",
            "house_rules":"wich is fall most expensive car",
