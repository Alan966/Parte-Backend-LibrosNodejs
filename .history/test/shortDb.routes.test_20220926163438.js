...
describe('POST /shortDb/create', () => {
    ...
    describe('given a valid reques', () => {
        const data = {
            listing_url:"https://cdn-images.farfetch-contents.com/15/95/78/61/15957861_30145315_1000.jpg",
            name:"wordCrack",
            summary:"you is the most",
            space:"where is the best ",
            description:"Where is the descript forget",
            neighborhood_overview:"Roberther on second first",
            notes:"second first",
            transit:"the first sit the bethieend",
            access:"you´re te most expensive car for play",
            interaction:"while is the most expensive",
            house_rules:"The best car is the most poor",
            property_type:"Shaving",
            room_type:"United",
            bed_type:"empoment",
            minimum_nights:"4",
            maximum_nights:"4",
        ...
        // afterAll(async () => {
        //     await shortDb.deleteMany({name: 'wordCrack'});
        // })
