...
describe('POST /shortDb/create', () => {
    ...
    describe('given a valid reques', () => {
        const data = {
            "_id":"5f2b5c9e7c4bxcxcxcxcxcxcxc",
            ...
            "summary":"This is a fantastic and this is the  inversion for you",
            "space":"The space isn't the most bigger on the city is very tall and is better",
            "description":"the description isn't the most important when you write your information about with house",
            "neighborhood_overview":"The overiview of the river with  you cann't find several restaurant as",
            "notes":"The most notes with this notes don't but is the best apatment",
            "transit":"transport across the apartment is the best with the block ",
            "access":"The house is find the bester interesting about the transit",
            "interaction":"Cost -10 e night god 7.5 Owww",
            "house_rules":"Make the house your home bitch if you don't make this house your home you're is killed ",
            "property_type":"Casita chill",
