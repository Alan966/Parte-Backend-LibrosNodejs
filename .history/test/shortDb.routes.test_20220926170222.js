...
describe('POST /shortDb/create', () => {
    ...
    describe('given a valid reques', () => {
        const data = {
            listing_url:"https://cdn-images.farfetch-contents.com/17/63/65/56/17636556_37241413_1000.jpg",
            name:"queOvole",
            summary:"Algo Rico",
        ...
        afterAll(async () => {
            await shortDb.deleteMany({listing_url:"https://cdn-images.farfetch-contents.com/17/63/65/56/17636556_37241413_1000.jpg"});
        })
