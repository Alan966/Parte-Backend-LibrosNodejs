...
describe('POST /shortDb/create', () => {
    ...
    describe('given a valid reques', () => {
        const data = {
            ...
            "name":"tenis Air Jordan 1 Retro",
            "summary":"Tenis Air Jordan 1 Retro en cuero de Jordan con puntera redonda, suela de goma y cierre con lazo.",
            "space":"Estos estilos llegan a nosotros gracias a un marketplace de tenis especializados y piezas difíciles",
            "description":"de conseguir. Cada producto es rigurosamente inspeccionado por expertos que garantizan su autenticidad.",
            "neighborhood_overview":"Todos nuestros envíos son conscientes con el ambiente",
            "notes":"Devoluciones gratis en 14 días (excepto en las rebajas finales, en las piezas personalizadas y en los cubrebocas)",
            "transit":"Estándar: 30 sept - 3 oct",
            "access":"Costo de envío único",
            "interaction":"Hong Kong y Baréin. Esto significa que todas las tasas de aduana están incluidas en el pedido, de forma que el precio que ves es el precio final de pago.",
            "house_rules":"Completa tu look con...",
            "property_type":"tenis Air Jordan 1 Retro",
            "room_type":"tenis Air Jordan 1 Retro",
            "bed_type":"Jordan",
            "minimum_nights":"4",
            "maximum_nights":"5",
