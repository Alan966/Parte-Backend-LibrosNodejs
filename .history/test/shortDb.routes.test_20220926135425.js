...
describe('POST /shortDb/create', () => {
    ...
    describe('given a valid reques', () => {
        const data = {
            "_id":"987684738291",
            "listing_url":"https://cdn-images.farfetch-contents.com/15/36/77/58/15367758_26939181_1000.jpg",
            "name":"tenis Air Force with the most",
            "summary":"New temper",
            "space":"Jordadin 2",
            "description":"Blanco, negro, morado oscuro, cuero, with about the Swoosh característico, logo Air Jordan Wings",
            "neighborhood_overview":"característico, panel in contentipe add , puntera redonda",
            "notes":"cierre with an people la parte delantera, diseño x el",
            "transit":"tobillo, plantilla before the  logo y suela de goma. Estos estilos",
            "access":"son suministrados with one of marketplace de tenis, with the cual",
            "interaction":"Todos nuestros envíos with conscientes for the ambiente",
            "house_rules":"Estándar:with 30 sept",
            "property_type":"Envío ",
            "room_type":"Unidos",
            "bed_type":"ENTREGA",
            "minimum_nights":"3",
