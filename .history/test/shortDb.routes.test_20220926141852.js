...
describe('POST /shortDb/create', () => {
    ...
    describe('given a valid reques', () => {
        const data = {
            "listing_url":"https://cdn-images.farfetch-contents.com/14/11/82/83/14118283_18741056_1000.jpg",
            "name":"Impuestos Aduanuales incluidos",
            "summary":"Nuevo temperamento mis panas",
            "space":"este es un espacio ",
            "description":"Ya no se que poner we ya",
            "neighborhood_overview":"tenis air jordan one retro first",
            "notes":"watch si the most expensive car in the new car",
            "transit":"you should create new car bro",
            "access":"you don't need cash you don't need there , there is debit card bro",
            "interaction":"Nostros no necesitamos nada",
            "house_rules":"wich is the most expensive car",
            "property_type":"Shaving with roles",
